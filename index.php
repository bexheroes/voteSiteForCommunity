			...
			window.onload = function(){
				...
				$('#a2').focusin(function(){
				   ...
				   $('#send_but').click(function(){
					   ...
					   $.ajax({
						   type:'POST',
						   url:'http://hacettepe.ueuo.com/process.php',
						   data:data,
						   success:function(g){
								if(g==2){
									$('#error1').fadeIn(1200);
					...
					<div id="form_in">
						...
						<div id="area2">
							...
							<div id="area2_line">
								...
								<div id="area2_colm" class="edit"><div>17:00-17:30</div></div>
								<div id="area2_colm" class="edit"><div>17:30-18.00</div></div>
							</div>
